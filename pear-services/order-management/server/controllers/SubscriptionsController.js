/**
 * The SubscriptionsController file is a very simple one, which does not need to be changed manually,
...
const service = require('../services/SubscriptionsService');
const cancelSubscription = async (request, response) => {
  await Controller.handleRequest(request, response, service.cancelSubscription);
};
...
const listSubscriptions = async (request, response) => {
  await Controller.handleRequest(request, response, service.listSubscriptions);
};
