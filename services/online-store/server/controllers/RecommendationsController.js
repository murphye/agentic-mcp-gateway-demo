/**
 * The RecommendationsController file is a very simple one, which does not need to be changed manually,
...
const getRelatedProducts = async (request, response) => {
  await Controller.handleRequest(request, response, service.getRelatedProducts);
};
